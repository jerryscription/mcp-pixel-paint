...
import { CreateCanvasSchema, SetPixelSchema, DrawLineSchema, DrawRectangleSchema, FloodFillSchema, SaveImageSchema, LoadImageSchema, GetCanvasInfoSchema, ClearCanvasSchema, ListColorsSchema } from './schemas.js';
class PixelPaintServer {
    ...
    async handleDrawRectangle(args) {
        const canvas = this.getCanvas(args.canvas_name);
    ...
    async handleGetCanvasInfo(args) {
        const canvas = this.getCanvas(args.canvas_name);
