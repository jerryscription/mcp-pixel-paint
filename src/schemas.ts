...
export type CreateCanvasArgs = z.infer<typeof CreateCanvasSchema>;
export type SetPixelArgs = z.infer<typeof SetPixelSchema>;
export type DrawLineArgs = z.infer<typeof DrawLineSchema>;
export type DrawRectangleArgs = z.infer<typeof DrawRectangleSchema>;
export type FloodFillArgs = z.infer<typeof FloodFillSchema>;
export type SaveImageArgs = z.infer<typeof SaveImageSchema>;
export type LoadImageArgs = z.infer<typeof LoadImageSchema>;
export type GetCanvasInfoArgs = z.infer<typeof GetCanvasInfoSchema>;
export type ClearCanvasArgs = z.infer<typeof ClearCanvasSchema>;
export type ListColorsArgs = z.infer<typeof ListColorsSchema>;